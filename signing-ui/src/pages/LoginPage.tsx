    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ backgroundColor: 'var(--bg-deep)' }}>
      <div className="w-full max-w-[440px]">
        ...
        <div className="card-elevated overflow-hidden">
          <div className="px-8 py-6" style={{ borderBottom: '1px solid var(--border)', backgroundColor: 'var(--bg-elevated)' }}>
            <h2 className="text-xl font-semibold" style={{ fontFamily: 'Poppins, sans-serif', color: 'var(--text-primary)' }}>
              Welcome back
            </h2>
          ...
          <div className="p-8 flex flex-col gap-4">
            {/* Error */}
            {error && (
              <div className="flex items-start gap-2 px-4 py-3 rounded-lg" style={{ backgroundColor: 'var(--red-dim)', border: '1px solid var(--red)' }}>
              ...
              <>
                {oauthStatus.google && (
                  <a
                    ...
                    className="flex items-center justify-center gap-3 w-full px-4 py-3 rounded-[10px] text-sm font-semibold transition-all"
                    style={{ 
                ...
                <div className="flex items-center gap-3 my-2">
                  ...
                  <span className="text-xs font-semibold" style={{ color: 'var(--text-tertiary)' }}>or</span>
                  <div className="flex-1 h-px" style={{ backgroundColor: 'var(--border-light)' }} />
                </div>
              </>
            )}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="input-field pl-10 pr-3 py-3 text-sm font-medium"
                  autoFocus
                  autoComplete="email"
                />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="input-field pl-10 pr-10 py-3 text-sm font-medium"
        ...
        <p className="text-center text-sm font-medium mt-6" style={{ color: 'var(--text-secondary)' }}>
          ...
          <Link to="/register" className="font-semibold hover:underline transition-all" style={{ color: 'var(--accent)' }}>
            Create one
          </Link>
        </p>
