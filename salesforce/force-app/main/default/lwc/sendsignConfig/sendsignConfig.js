...
import testConnection from '@salesforce/apex/SendSignConfig.testConnection';
import saveSettings from '@salesforce/apex/SendSignConfig.saveSettings';
...
export default class CosealConfig extends LightningElement {
    ...
    async handleTestConnection() {
        ...
        try {
            ...
            this.connectionMessage = result.connected
                ? 'Connected to SendSign successfully!'
    ...
    async handleSave() {
        ...
        try {
            ...
            this.dispatchEvent(new ShowToastEvent({
                title: 'Saved',
                message: 'SendSign settings saved.',
                variant: 'success'
            }));
        } catch (error) {
            this.dispatchEvent(new ShowToastEvent({
