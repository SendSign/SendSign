# /sendsign:template — Manage Templates
...
### Use a Template
**User:** "/sendsign:send --template Standard NDA"
...
4. Creates template
5. Responds: "✓ Template 'Standard NDA' created. Use `/sendsign:send --template Standard NDA` to send it."
