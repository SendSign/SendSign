# /sendsign:status — Check Envelope Status
...
- If pending: "Would you like to send a reminder? Use `/sendsign:remind {envelopeId}`"
- If completed: "Would you like to download the signed document? Use `/sendsign:download {envelopeId}`"
- If expired: "This envelope has expired. You can void it with `/sendsign:void {envelopeId}`"
...
**User:** "/sendsign:status env_abc123"
